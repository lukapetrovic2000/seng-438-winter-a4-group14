...
public class DataUtilitiesTest extends DataUtilities {
	...
	public void testingGetCumalativePercFirstKey() {
		assertEquals(0.28125, getCumulativePercentages(actual).getValue(0));
	}
	...
	/**
	 * Given negative row index. 
	 */
	@Test
	public void testCalcRowTabForOutBoundRow() { 		
	...
	//tests if a non-empty array is correctly copied
		...
		public void validArrayTest() {
			...
			assertArrayEquals("data sets should be identical", numbers, actual);
		}
